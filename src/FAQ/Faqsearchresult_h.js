        ...
        <div className="col " style={{paddingLeft:"0", paddingRight:"0"}}>
          <div className="faq--search--container--h row mx-auto">
            <div className="faq--search--result--h">
              ...
              <p>
                There are 12 Stations with <span>“Loream Ipsum”</span> on <span>FAQs</span>
              </p>
            </div>
              ...
              <div className="faq--container--right-h">
                <div className="card text-center faq--right--card">
                  <div className="card-body faq--right--card--body">
                    <h1 className="card-title">Can't find question you're looking for?</h1>
                    <p className="card-text">
                      Pellentesque vel tristique ultrices habitasse feugiat nulla tempor quam. Et risus commodo natoque pulvinar
                      eu, interdum.
                    </p>
                    <div className="d-grid gap-2 col-8 mx-auto">
                      <button className="btn btn-primary faq--right--button--h" type="button">
                        Contact us
                      </button>
                    </div>
                  </div>
