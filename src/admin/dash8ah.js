...
return(
  ...
  <path d="M11.9487 6.9707C11.4608 6.9707 11.0653 7.36623 11.0653 7.85413V11.1541H7.76477C7.27687 11.1541 6.88135 11.5496 6.88135 12.0375C6.88135 12.5254 7.27687 12.921 7.76477 12.921H11.0653V16.2215C11.0653 16.7094 11.4608 17.1049 11.9487 17.1049C12.4366 17.1049 12.8322 16.7094 12.8322 16.2215V12.921H16.1322C16.6201 12.921 17.0156 12.5254 17.0156 12.0375C17.0156 11.5496 16.6201 11.1541 16.1322 11.1541H12.8322V7.85413C12.8322 7.36623 12.4366 6.9707 11.9487 6.9707Z" fill="#194D79"/>
</svg>
...
<select name="" id="">
  ...
  <tr  key={index}>
    <td>#0001</td>
    <td className="gg-td"><div className="admin-dp"><img src={adminz}alt="" /></div>Brooklyn Simmons</td>
    <td>KABC</td>
    <td>June 23, 2022</td>
    <td ><div className="new-Unauthorized">Unauthorized</div></td>
    <td><Btn/></td>
