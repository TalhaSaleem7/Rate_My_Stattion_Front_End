                                ...
                                <div className="dashrepoting_rating_box">
                                    <div class="latest-rating-box">
                                        ...
                                        <div class="racial-discrimination">
                                            ...
                                            <h5>
                                                Everyone is the best at what they do. Management is
                                                great. No complaints. Eu pellentesque nibh...{" "}
                                                <a href="#">see more</a>
                                            </h5>
                                        </div>
                                        ...
                                        <div className="report_ratingigdel_btn">
                                            <a href="#" className="ignore_all">Ignore</a>
                                            <a href="#" className="delete_all">Delete</a>
                                            <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="7" height="26" viewBox="0 0 7 26" fill="none">
