...
const EducationForm = (handleClose) => {
  ...
  const handleFormDataChange = (name, value) => {
   ...
   const handleSubmit = async (e) => {
    ...
    if (!school || !degree || !fieldOfStudy || !startMonth || !startYear || !endMonth || !endYear || !description) {
        ...
        <div className="row">
          <div className="col">
            ...
            <div className="col-12 mb-3 mt-1">
              <label htmlFor="inputAddress" className="form-label form-label-alt">School</label>
              <input
                type="text"
            ...
            <div className="col-12 mb-3 mt-1">
              <label htmlFor="inputDegree" className="form-label form-label-alt">Degree</label>
              <input
                type="text"
                className="form-control experience--address--inp--h"
                id="inputDegree"
            ...
            <div className="col-12 mb-3 mt-1">
              <label htmlFor="inputFieldOfStudy" className="form-label form-label-alt">Field of Study</label>
              <input
                type="text"
                className="form-control experience--address--inp--h"
                ...
                onChange={(e) => handleFormDataChange('fieldOfStudy', e.target.value)}
              />
            </div>
            ...
            <div className="mb-3">
              <label htmlFor="exampleFormControlTextarea1" className="form-label form-label-alt">Description</label>
              <textarea
