...
import { RiMapPin2Fill, RiMoneyDollarCircleFill, RiTimeLine, RiMore2Fill, RiCheckboxCircleFill } from 'react-icons/ri';
...
const Asistantnewsdirector = () => {
  return (
    <>
     <div className="assistant-news-director-box">
            ...
            <div className="actively-hiring-updated">
                <a href="#"><RiCheckboxCircleFill /> Actively Hiring</a>
                <p><RiTimeLine /> Updated 8 hours ago</p>
            </div>
        </div>
    </>
  )
