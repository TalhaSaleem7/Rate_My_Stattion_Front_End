...
import { RiFacebookFill, RiInstagramLine, RiTwitterFill, RiSearchLine, RiThumbUpFill, RiFlagFill, RiVerifiedBadgeFill } from 'react-icons/ri';
                ...
                <div class="latest-rating-box">
                  <div class="latest-rating-user-verified">
                      ...
                      <div class="latest-rating-user-txt">
                        ...
                        <div className="jobdetail-click-btn">
                          <h6 onClick={toggleDetails}>
                            Job details {isOpen ? <FaAngleUp /> : <FaAngleDown />}
                          </h6>
                          {isOpen && (
                    ...
                    <div class="verified-rating-box">
                      <h6><span class="rating-of">Rating of</span></h6>
