...
import { RiThumbUpFill, RiChat3Fill, RiShareFill, RiBookmarkFill, RiFlagFill, RiFacebookFill, RiInstagramLine, RiTwitterFill, RiSearchLine } from 'react-icons/ri';
                            ...
                            <div className="newsletter-long-txt">
                                <Slider {...settings} className="newsletter-article-slider">
                                    <div className="newsletter-article-decided">
                                        <h4>So you decided you want…no, you NEED…to be healthier.</h4>
                                        <p>
                                            ...
                                            et commodo sapien porta felis amet pellentesque.
                                        </p>
                                        <p>
                                            Erat augue enim turpis risus urna, ut egestas vivamus proin.
                                            Velit leo scelerisque pulvinar vestibulum in nunc a tortor
                                            mollis. Fusce pretium est ipsum elementum parturient.
                                            Venenatis, ac nulla non varius dolor. Ornare consectetur
                                            mauris, adipiscing tristique a leo.
                                        </p>
                                        <p>
                                            Habitant pharetra tellus habitasse vestibulum nibh quisque.
                                            Sed vel condimentum enim leo tortor mi magna tincidunt.
                                            Egestas bibendum id eget quisque semper ultricies. Gravida
                                            viverra massa faucibus vestibulum condimentum.
                                        </p>
                                        <p>
                                        ...
                                        <p>
                                            ...
                                            Risus vitae in turpis elementum, viverra ultricies. Commodo
                                            sed eget at massa, integer. Porta id id nisl faucibus neque,
                                            purus. Fermentum enim, sed ut ultrices amet turpis pharetra
                                            faucibus blandit. Aenean proin at tortor tincidunt. Aenean
                                            sed ornare sit arcu mattis amet, eget. Id sed amet cras urna
                                            et malesuada.
                                        </p>
                                    </div>
                                    <div className="newsletter-article-decided">
                                    ...
                                    <div class="newsletter-comment-txt">
                                        <div class="newsletter-detail-comment-para">
                                            ...
                                            <p>
                                                ...
                                                vel. Condimentum egestas vestibulum habitant.
                                            </p>
                                        </div>
                                ...
                                <div class="more-from-soul-witness-box">
                                    ...
                                    <div class="more-soul-article">
                                        ...
                                        <div class="more-soul-articletxt">
                                            <h4>So you decided you want…no, you NEED…to be healthier.</h4>
                                            <span><i class="ri-time-line"></i> May 24, 2022</span>
                                        </div>
                                    </div>
                                    <div class="more-soul-article">
                    ...
                    <Col lg={4}>
                        <div class="newsletter-side-sec">
                            <div class="newsletter-input-search">
                                <input type="search" name="" id="" placeholder="Search articles or writer" />
