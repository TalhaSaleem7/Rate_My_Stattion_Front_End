...
import { RiVerifiedBadgeFill, RiMapPinFill, RiArrowLeftSLine, RiArrowRightSLine } from 'react-icons/ri';
                                    ...
                                    <Col lg={8}>
                                        <div className="job-detailpg-nameflex">
                                            ...
                                            <div className="job-openingpg-txt">
                                                ...
                                                <h6><RiMapPinFill /> Los Angeles, CA | DMA: 2</h6>
                                            </div>
                                        </div>
                                    </Col>
                                    <Col lg={4}>
                                        <div className="job-select-opts">
                                            ...
                                            <a href="#" className='themelight'>See Station’s profile</a>
                                        </div>
                                    </Col>
                                </Row>
                            </div>
                    ...
                    <Row>
                        <Col lg={8}>
                            <div className="newsletter-article-search">
                                <h4>Available job opening <p>(6)</p></h4>
                            </div>
                        </Col>
                        <Col lg={4}>
