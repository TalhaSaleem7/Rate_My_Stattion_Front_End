        ...
        <div class="America-Sweatshirt">
          ...
          <div class="Sweatshirt-ah">
            ...
            <div class="Description-box-tital">
              <h2>Description</h2>
              <p>
                Our #AMNewser Sweatshirt is perfect to wear in the freezing
                newsroom. Don’t wait, this style is a limited edition, so place
                your order today!
              </p>

              <p>
                A sturdy and warm sweatshirt bound to keep you warm in the
                colder months. A pre-shrunk, classic fit sweater that’s made
                with air-jet spun yarn for a soft feel and reduced pilling.
              </p>

              <p>
                Above all, it feels soft and lightweight, with the right amount
                of stretch. It’s comfortable and flattering for both men and
                women, and you can choose from a large variety of different
                colors.
              </p>
